$(function () {
    ...
    $('body').on('click', function () {
        if ($('#wayra').find('.swiper-container').length) {
            var sw = $('#wayra').find('.swiper-container');
    ...
    $('body').on('click', function () {
        if ($('#mavs').find('.swiper-container').length) {
            var sw = $('#mavs').find('.swiper-container');
            swipers[sw.attr('data-init')].reInit();
            swipers[sw.attr('data-init')].resizeFix();
        }
    });
    ...
    $('body').on('click', function () {
        if ($('#thomond').find('.swiper-container').length) {
            var sw = $('#thomond').find('.swiper-container');
            swipers[sw.attr('data-init')].reInit();
            swipers[sw.attr('data-init')].resizeFix();
        }
    });
    ...
    $('body').on('click', function () {
        if ($('#apple').find('.swiper-container').length) {
            var sw = $('#apple').find('.swiper-container');
            swipers[sw.attr('data-init')].reInit();
            swipers[sw.attr('data-init')].resizeFix();
        }
    });
    ...
    $('body').on('click', function () {
        if ($('#cratus').find('.swiper-container').length) {
            var sw = $('#cratus').find('.swiper-container');
            swipers[sw.attr('data-init')].reInit();
            swipers[sw.attr('data-init')].resizeFix();
        }
    });
    ...
    $('body').on('click', function () {
        if ($('#dkit').find('.swiper-container').length) {
            var sw = $('#dkit').find('.swiper-container');
            swipers[sw.attr('data-init')].reInit();
            swipers[sw.attr('data-init')].resizeFix();
        }
    });
    ...
    $('body').on('click', function () {
        if ($('#re').find('.swiper-container').length) {
            var sw = $('#re').find('.swiper-container');
            swipers[sw.attr('data-init')].reInit();
            swipers[sw.attr('data-init')].resizeFix();
        }
    });
    ...
    $('body').on('click', function () {
        if ($('#snow').find('.swiper-container').length) {
            var sw = $('#snow').find('.swiper-container');
            swipers[sw.attr('data-init')].reInit();
            swipers[sw.attr('data-init')].resizeFix();
        }
    });
    ...
    $('body').on('click', function () {
        if ($('#start').find('.swiper-container').length) {
            var sw = $('#start').find('.swiper-container');
            swipers[sw.attr('data-init')].reInit();
            swipers[sw.attr('data-init')].resizeFix();
        }
    });
    ...
    $('body').on('click', function () {
        if ($('#storpal').find('.swiper-container').length) {
            var sw = $('#storpal').find('.swiper-container');
            swipers[sw.attr('data-init')].reInit();
            swipers[sw.attr('data-init')].resizeFix();
        }
    });
    ...
    $('body').on('click', function () {
        if ($('#infinite').find('.swiper-container').length) {
            var sw = $('#infinite').find('.swiper-container');
            swipers[sw.attr('data-init')].reInit();
            swipers[sw.attr('data-init')].resizeFix();
        }
    });
    ...
    $('body').on('click', function () {
        if ($('#suir').find('.swiper-container').length) {
            var sw = $('#suir').find('.swiper-container');
            swipers[sw.attr('data-init')].reInit();
            swipers[sw.attr('data-init')].resizeFix();
        }
    });
    ...
    $('body').on('click', function () {
        if ($('#topaz').find('.swiper-container').length) {
            var sw = $('#topaz').find('.swiper-container');
            swipers[sw.attr('data-init')].reInit();
            swipers[sw.attr('data-init')].resizeFix();
        }
    });
    ...
    $('body').on('click', function () {
        if ($('#vodafone').find('.swiper-container').length) {
            var sw = $('#vodafone').find('.swiper-container');
            swipers[sw.attr('data-init')].reInit();
            swipers[sw.attr('data-init')].resizeFix();
        }
    });
    ...
    $('body').on('click', function () {
        if ($('#blackshadow').find('.swiper-container').length) {
            var sw = $('#blackshadow').find('.swiper-container');
            swipers[sw.attr('data-init')].reInit();
            swipers[sw.attr('data-init')].resizeFix();
        }
    });
    ...
    $('body').on('click', function () {
        if ($('#hop').find('.swiper-container').length) {
            var sw = $('#hop').find('.swiper-container');
            swipers[sw.attr('data-init')].reInit();
            swipers[sw.attr('data-init')].resizeFix();
        }
    });
